...
*  **Deep Dive:** Mastering **Go** (currently about 60% of the way through my roadmap to full proficiency, focusing on standard library routing and clean architectures).
...
* **Backend:** Node.js, Express, Go standard HTTP, Prisma, Gorm
* **Databases:** PostgreSQL, MySQL, Supabase
* **Environment:** Linux (Ubuntu), Neovim, Git (HTTPS workflow)
